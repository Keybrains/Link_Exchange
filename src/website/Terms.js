      ...
      <Page title="Terms & Conditions" sx={{ padding: '25px', overflow: 'hidden' }}>
        ...
        <Card sx={{ padding: '25px', overflow: 'hidden' }}>
          ...
          <Typography variant="body1" style={{ marginBottom: '1rem', marginLeft: '1rem' }}>
            Withdrawals can be made to your PayPal account only. Please note that the final sum you receive to your
            PayPal account will differ from the one you see on your Adsy account. That’s because we charge a 7.9%
