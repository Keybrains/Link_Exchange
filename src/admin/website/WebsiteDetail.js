                      ...
                      <MDBCardBody className="p-4 pb-4">
                          ...
                          <>
                            ...
                            <MDBRow>
                              <MDBCol size="12" lg="6" className="mb-3 d-flex">
                                ...
                                <MDBCardText className="text-muted">{websiteDetail.reportedWebsites?.message}</MDBCardText>
                              </MDBCol>
                        ...
                        <MDBRow>
                          <MDBCol size="12" lg="6" className="mb-3 d-flex">
                            ...
                            <MDBCardText className="text-muted">{websiteDetail.website?.backlinksAllowed}</MDBCardText>
                          </MDBCol>
                          <MDBCol size="12" lg="6" className="mb-3 d-flex">
                            <MDBTypography tag="h6" className="me-2">
                              Country :
                        ...
                        <MDBRow>
                          ...
                          <MDBCol size="12" lg="6" className="mb-3 d-flex">
                            ...
                            <MDBCardText className="text-muted"> ${websiteDetail.website?.charges || 0}</MDBCardText>
                          </MDBCol>
                        </MDBRow>
                                ...
                                case 'activate':
                                  return (
                                    <Tooltip title="To Deactivate URL - Click Here">
                                      <MDBCardText variant="outlined" style={{ color: 'green', borderColor: 'green' }}>
                                        Activate
                                      </MDBCardText>
                                    </Tooltip>
                                  );
