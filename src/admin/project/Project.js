    ...
    <>
      ...
      >
        <Paper elevation={3} sx={{ width: '100%', p: 3, borderRadius: 2, boxShadow: '0 8px 16px 0 rgba(0,0,0,0.2)' }}>
          <Typography variant="h5" gutterBottom component="div" sx={{ fontWeight: 'medium', color: 'primary.main' }}>
          ...
          <TableBody>
            {projects.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((project) => (
              <TableRow key={project._id}>
                ...
                <TableCell>
                  <IconButton onClick={() => handleClickOpen(project.project_id)} color="error" size="small">
