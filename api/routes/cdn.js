...
// const baseUrl = 'http://localhost:5000/api/cdn/upload';
const baseUrl = process.env.REACT_APP_API_BASE_URL_BACKEND;
...
router.put('/upload/:filetype/:filename', upload.single('files'), async (req, res) => {
  try {
    const filename = req.params.filename;
    const filetype = req.params.filetype;
